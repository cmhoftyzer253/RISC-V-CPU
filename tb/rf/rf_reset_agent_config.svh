class rf_reset_agent_config extends uvm_object;
    `uvm_object_utils(rf_reset_agent_config)

    protected virtual rf_if             rf_vif;
    protected uvm_active_passive_enum   is_active;

    function new(string name = "rf_reset_agent_config");
        super.new(name);
...
endclass : rf_reset_agent_config
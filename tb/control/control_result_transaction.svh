class control_result_transaction extends uvm_sequence_item;
    ...
    function string convert2string();
        ...
        s = $sformatf("pc_sel_o: %b, opa_sel_o: %b, opb_sel_o: %b, exu_func_sel_o: %b, rd_src_o: %b, csr_en_o: %b, csr_rw_o: %b, 
            ...
            pc_sel_o, opa_sel_o.name(), opb_sel_o.name(), exu_func_sel_o, rd_src_o.name(), rd_src_o, csr_en_o, csr_rw_o,
            data_req_o, data_byte_o.name(), bypass_avail_o.name(), data_wr_o, zero_extnd_o, rf_wr_en_o, word_op_o, alu_instr_o, div_instr_o,
            mret_o, wfi_o, exc_valid_o, exc_code_o);

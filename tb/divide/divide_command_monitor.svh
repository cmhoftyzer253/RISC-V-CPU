class divide_command_monitor extends uvm_component;
    `uvm_component_utils(divide_command_monitor)

    divide_command_agent_config                         agent_config;
    uvm_analysis_port #(divide_command_transaction)     ap;
    ...
    task run_phase(uvm_phase phase);
        ...
        forever begin
            ...
            if (multiply_vif.mon_cb.div_valid_i && divide_vif.mon_cb.div_ready_o && !divide_vif.mon_cb.flush_i) begin
                ...
                cmd.div_valid_i     =   multiply_vif.mon_cb.div_valid_i;
                cmd.div_func_i      =   multiply_vif.mon_cb.div_func_i;
...
endclass : divide_command_monitor
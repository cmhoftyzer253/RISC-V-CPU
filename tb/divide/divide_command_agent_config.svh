class divide_command_agent_config extends uvm_object;
    `uvm_object_utils(divide_command_agent_config)

    protected virtual divide_if       divide_vif;
    protected uvm_active_passive_enum   is_active;

    function new(string name = "divide_command_agent_config");
        super.new(name);
...
endclass : divide_command_agent_config
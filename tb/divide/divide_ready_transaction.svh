class divide_ready_transaction extends uvm_sequence_item;
    `uvm_object_utils(divide_ready_transaction)

    function new(string name = "divide_ready_transaction");
        super.new(name);
    endfunction : new
...
endclass : divide_ready_transaction
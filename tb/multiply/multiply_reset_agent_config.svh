class multiply_reset_agent_config extends uvm_object;
    `uvm_object_utils(multiply_reset_agent_config)

    protected virtual multiply_if       multiply_vif;
    protected uvm_active_passive_enum   is_active;

    function new(string name = "multiply_reset_agent_config");
        super.new(name);
...
endclass : multiply_reset_agent_config
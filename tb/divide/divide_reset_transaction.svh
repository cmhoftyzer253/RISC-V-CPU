class divide_reset_transaction extends uvm_sequence_item;
    `uvm_object_utils(multiply_reset_transaction)

    function new(string name = "divide_reset_transaction");
        super.new(name);
    endfunction : new
...
endclass : divide_reset_transaction
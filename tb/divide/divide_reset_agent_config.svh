class divide_reset_agent_config extends uvm_object;
    `uvm_object_utils(divide_reset_agent_config)

    protected virtual divide_if         divide_vif;
    protected uvm_active_passive_enum   is_active;

    function new(string name = "multiply_reset_agent_config_h");
        super.new(name);
...
endclass : divide_reset_agent_config